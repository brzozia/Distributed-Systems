...
import pl.travel.data.amadeusAPI.Airports;
...
public class AmadeusAPI {
    ...
    public FlightDestinations getFlights(String origin, String departure, boolean oneWay, String duration, Integer maxPrice ) throws Exception {
        String url = this.url + "/shopping/flight-destinations?origin=" + origin +
                (departure.equals("") ? "" : ("&departureDate=" +departure) )
                +"&oneWay="+oneWay+ (!duration.equals("") ? ("&duration=" +duration) : "" )
