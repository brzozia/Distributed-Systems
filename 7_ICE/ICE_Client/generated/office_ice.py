...
if 'BuildingOptions' not in _M_OfficeData.__dict__:
    ...
    BuildingOptions._enumerators = {0: BuildingOptions.NewBuilding, 1: BuildingOptions.BuildingExpansion,
                                    2: BuildingOptions.BuildingDemolition}

    _M_OfficeData._t_BuildingOptions = IcePy.defineEnum('::OfficeData::BuildingOptions', BuildingOptions, (),
                                                        BuildingOptions._enumerators)
...
if 'IDReason' not in _M_OfficeData.__dict__:
    ...
    IDReason._enumerators = {0: IDReason.firstID, 1: IDReason.dataChange, 2: IDReason.imageChange, 3: IDReason.idDamage,
                             4: IDReason.idLost}
...
if 'Request' not in _M_OfficeData.__dict__:
    ...
    _M_OfficeData._t_Request = IcePy.defineValue('::OfficeData::Request', Request, -1, (), False, False, None,
                                                 (('person', (), _M_OfficeData._t_Person, False, 0),))
...
if 'BuildingPermission' not in _M_OfficeData.__dict__:
    ...
    class BuildingPermission(_M_OfficeData.Request):
        def __init__(self, person=Ice._struct_marker, city='', street='', number=0,
                     option=_M_OfficeData.BuildingOptions.NewBuilding):
    ...
    _M_OfficeData._t_BuildingPermission = IcePy.defineValue('::OfficeData::BuildingPermission', BuildingPermission, -1,
                                                            (), False, False, _M_OfficeData._t_Request, (
                                                                ('city', (), IcePy._t_string, False, 0),
                                                                ('street', (), IcePy._t_string, False, 0),
                                                                ('number', (), IcePy._t_short, False, 0),
                                                                ('option', (), _M_OfficeData._t_BuildingOptions, False,
                                                                 0)
                                                            ))
...
if 'VehicleRegistration' not in _M_OfficeData.__dict__:
    ...
    _M_OfficeData._t_VehicleRegistration = IcePy.defineValue('::OfficeData::VehicleRegistration', VehicleRegistration,
                                                             -1, (), False, False, _M_OfficeData._t_Request, (
...
if 'IDCardIssuing' not in _M_OfficeData.__dict__:
    ...
    class IDCardIssuing(_M_OfficeData.Request):
        def __init__(self, person=Ice._struct_marker, phoneNumber='', familyName='', gender=_M_OfficeData.Gender.woman,
                     reason=_M_OfficeData.IDReason.firstID):
            _M_OfficeData.Request.__init__(self, person)
    ...
    _M_OfficeData._t_IDCardIssuing = IcePy.defineValue('::OfficeData::IDCardIssuing', IDCardIssuing, -1, (), False,
                                                       False, _M_OfficeData._t_Request, (
...
_M_OfficeData._t_\
    = IcePy.defineValue('::OfficeData::Citizen', Ice.Value, -1, (), False, True, None, ())
...
if 'CitizenPrx' not in _M_OfficeData.__dict__:
    ...
    Citizen._op_handleResponse = IcePy.Operation('handleResponse', Ice.OperationMode.Normal, Ice.OperationMode.Normal,
                                                 False, None, (), (((), _M_OfficeData._t_Result, False, 0),), (), None,
                                                 ())
...
if 'OfficePrx' not in _M_OfficeData.__dict__:
    ...
    Office._op_requestBuildingIssue = IcePy.Operation('requestBuildingIssue', Ice.OperationMode.Normal,
                                                      Ice.OperationMode.Normal, False, None, (),
                                                      (((), _M_OfficeData._t_BuildingPermission, False, 0),), (),
                                                      ((), IcePy._t_int, False, 0), ())
    Office._op_requestVehicleIssue = IcePy.Operation('requestVehicleIssue', Ice.OperationMode.Normal,
                                                     Ice.OperationMode.Normal, False, None, (),
                                                     (((), _M_OfficeData._t_VehicleRegistration, False, 0),), (),
                                                     ((), IcePy._t_int, False, 0), ())
    Office._op_requestIDCardIssue = IcePy.Operation('requestIDCardIssue', Ice.OperationMode.Normal,
                                                    Ice.OperationMode.Normal, False, None, (),
                                                    (((), _M_OfficeData._t_IDCardIssuing, False, 0),), (),
                                                    ((), IcePy._t_int, False, 0), ())
    Office._op_connect = IcePy.Operation('connect', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (),
                                         (((), IcePy._t_string, False, 0), ((), _M_OfficeData._t_CitizenPrx, False, 0)),
                                         (), None, ())
